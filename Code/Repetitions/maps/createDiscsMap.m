...
stim_name = 'discs';
stim_version = '181123_PairedPulseBg_230';
...
rep_begin_white = find([0; visual_sequence(1:end-1)] == 0 &  visual_sequence(1:end) == white_state);
rep_end_white = find([0; visual_sequence(1:end-1)] == white_state &  visual_sequence(1:end) == 0);
...
repetitions_map.names{1} = 'white_pulse';
