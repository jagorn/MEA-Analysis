...
for i_class = 1:numel(mosaics_classes)
    ...
    class_file = strcat('/home/fran_tr/Projects/MEA-Analysis/Thesis/Typing/Data/', class_name, 'mat');
    ...
    fprintf("CLASS %s: core size = %i, residual size = %i\n", symbol, size(non_linearities_both, 1), size(non_linearities_sta, 1));
