...
exp_file_stas = fullfile("/home/fran_tr/Projects/MEA-Analysis/Thesis/Typing/Data", strcat(exp_id, "_stas.mat"));
load(exp_file, 'mea_rate', 'rep_begin');
load(exp_file, 'SpikeTimes', 'Valid_STAs_idx');
load(exp_file_stas, 'temporal');
load(exp_file, 'euler', 'euler_freq', 'euler_sampler_rate', 'euler_polarity_inverse', 'euler_onset_idx', 'euler_offset_idx');
